...
var table_equipment = $('.table_branch').DataTable({
	"ajax":
	{
		"url": "../class/display/display",
		"type": "POST",
...
var table_inventory_new = $('.table_inventory_new_branch').DataTable({
	"ajax":
	{
		"url": "../class/display/display",
		"type": "POST",
		"data": {
			"key": "display_equipment_new_branch"
		}
	},
	"columns":
		[
