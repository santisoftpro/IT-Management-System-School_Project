			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-pills">
						...
						<li><a href="#damaged" data-toggle="tab"><i
									class="fa fa-file-code-o"></i>&nbsp;&nbsp;Damaged</a></li>
						<li><a href="#pulledout" data-toggle="tab"><i
									class="fa fa-chevron-circle-right"></i>&nbsp;&nbsp;Total Items</a></li>
						<li><a href="#transferred" data-toggle="tab"><i
									class="fa fa-chevron-circle-right"></i>&nbsp;&nbsp;Transferred</a></li>
						<li><a href="#report2" data-toggle="tab"><i
									class="fa fa-chevron-circle-right"></i>&nbsp;&nbsp;Borrowed</a></li>
					</ul>
				</div>
				<!-- <div class="col-md-2">
								...
								<thead>
									...
									<tr>
										...
										<div id="" style=" margin-right:20px">
											...
											echo "</option>";
											while ($pics = mysql_fetch_array($pic)) {
