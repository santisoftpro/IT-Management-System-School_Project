                ...
                <div class="panel-body">
                    <table class="table dataTable no-footer" id="DataTables_Table_0" role="grid"
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($con, "SELECT * FROM item WHERE branch_name = '$name'");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="items_info?item=' . $value['e_id'] . '&1Qke#%Rasd2#a1Qasd"
                                                class="btn btn-primary"><i class="fa fa-search"></i> More info</a>
