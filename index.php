...
<head>
    <meta charset="utf-8">
    <title>UNILAK-Kigali-Campus</title>
    ...
    <div class="container-fluid p-0 mb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/nikita-kachanovsky-OVbeSXRk_9E-unsplash.jpg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
                    style="background: rgba(0, 0, 0, .4);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">SERVICE & RENTING
                                    Services</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">BEST SERVICE OF OUR SCHOOL
                                    ORGANISATION</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">ICT Laboratory Management System. </p>
                                <a href="lab/index"
                                    class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Main
                                    Compus</a>

                                <a href="lab/branch/login"
                                    class="btn btn-secondary py-md-3 px-md-5 me-3 animated slideInLeft">Compus
                                    Login
                                </a>
                                <a href="lab/member/login"
                                    class="btn btn-warning py-md-3 px-md-5 me-3 animated slideInLeft">User
                                    Login</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/philipp-katzenberger-jVx8JaO2Ddc-unsplash.jpg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
                    style="background: rgba(0, 0, 0, .4);">
                    <div class="container">
                        <div class="row justify-content-start">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="img/12240034_506638416174041_2986251706726073419_n.jpg"
                            alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        <h5 class="text-truncate me-3 mb-0">UNILAK Nyanza Campus</h5>
                ...
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.3s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="img/c07a9980_-_copy-6facb-edited.jpg" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        <h5 class="text-truncate me-3 mb-0">UNILAK Rwamagana Campus</h5>
                        <a class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0" href="#"><i
                                class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.5s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="img/UNILAK-Kigali-Campus-1024x683.webp" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        <h5 class="text-truncate me-3 mb-0">UNILAK Kigali campus (main)</h5>
                        <a class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0" href=""><i
                                class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-4">We Rent Material From different Branches of Our University</h1>
                    <p class="mb-4">international conference where UNILAK with fellow researchers share knowledge
                        ...
                        stakeholders. </p>
                    <p class="fw-medium text-primary"><i class="fa fa-check text-success me-3"></i>UNILAK Kigali campus
                        (main)</p>
                    <p class="fw-medium text-primary"><i class="fa fa-check text-success me-3"></i>UNILAK Rwamagana
                        Campus</p>
                    <p class="fw-medium text-primary"><i class="fa fa-check text-success me-3"></i>UNILAK Nyanza Campus
                    </p>

                </div>
                <div class="col-lg-6 pt-4" style="min-height: 500px;">
                    <div class="position-relative h-100 wow fadeInUp" data-wow-delay="0.5s">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/ryan-yao-BDvCewlnbD8-unsplash.jpg"
                        ...
                        <img class="position-absolute start-0 bottom-0 img-fluid bg-white pt-2 pe-2 w-50 h-50"
                            src="img/amy-hirschi-szrJ3wjzOMg-unsplash.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Our Experts</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/the-VC.webp" alt="">
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
                                <h5 class="fw-bold mb-0">THE VC</h5>
